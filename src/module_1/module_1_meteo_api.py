...
# Go through each city in the COORDINATES list and call the function to take each data.
    for city in COORDINATES.keys():
        ...
        print("Dates of:" + city + "\nTemperature - average: " + temperature_average + "- Dispersión: " + temperature_dispersion)
        print("Precipitation - average:" + precipitation_average + "- Dispersión: " + precipitation_dispersion)
        print("Soil moisture - average: " + soil_moisture_average + "- Dispersión: " + soil_moisture_dispersion)
        print("\n")
